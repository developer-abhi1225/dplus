...
export const data = [
  { image: sahrudaya_thumbnail, title: "Brand Development" },
  { image: cygnustics_thumbnail, title: "Web Application Design" },
  { image: India_millets_co_thumbnail, title: "Package Design" },
];
